            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    try
                    {
                        ...
                        var existingPerson = await _context.People.FirstOrDefaultAsync(p => p.Email == Input.Email);
                        ...
                        {
                            //allowing a repeat customer without an account to register with their email.
                            existingPerson.FirstName = Input.FirstName;
                            existingPerson.LastName = Input.LastName;
                            existingPerson.Phone = Input.Phone;
